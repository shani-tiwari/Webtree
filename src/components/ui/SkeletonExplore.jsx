...
const SkeletonExplore = () => {
  ...
  return (
    <SkeletonTheme baseColor="#18181b" highlightColor="#27272a">
      ...
      >
        <h1 className="sr-only">Loading Explore DeveloperResources</h1>

        {/* Header */}
        <header
          className={cn(
            "w-full flex justify-center text-center px-4 md:px-6 select-none",
          )}
        >
          <div className="w-fit">
            <Skeleton
              ...
              height={35}
              borderRadius={8}
              className="md:w-[250px] md:h-[45px]"
            />
          </div>
        </header>
        ...
        >
          ...
          <div
            className={cn(
              "-mt-4 md:-mt-10 pointer-events-none z-50 relative flex justify-center w-full",
            )}
          >
            <CustomSVG />
          </div>
