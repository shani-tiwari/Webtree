    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          "backdrop-blur-md cursor-pointer hover:transition-colors hover:duration-75 transition-all duration-400 ease-in-out select-none shadow-xs shadow-white/8 hover:shadow-[0_4px_15px_rgba(0,0,0,0.6)]",
          isActive
      ...
      >
        ...
        >
          ...
          {/* line */}
          {
            isActive && (
              <span
                className="absolute -bottom-[6px] md:-bottom-[9px] xl:-bottom-[9px] left-0 w-[95%] h-[0.9px] bg-linear-to-l from-transparent via-zinc-300 to-transparent "
              />
            )
          }
        </span>
