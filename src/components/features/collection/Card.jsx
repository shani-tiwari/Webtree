...
import SpotlightBorder from '../../ui/SpotlightBorder.jsx';
    ...
    return (
      <SpotlightBorder>
        ...
        >
          <section
            className={cn(
              "relative h-full flex flex-col bg-linear-to-tr from-black/10 via-black/5 to-white/8 backdrop-blur-md border border-stone-700 rounded-[30px] p-5",
              "transition-colors ease-[cubic-bezier(0.79,0.47,0.24,0.98)] duration-250 group cursor-pointer text-white/70 select-none shadow-md shadow-black hover:shadow-xl",
            )}
          >
