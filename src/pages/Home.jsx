  ...
  return (
    <>
      ...
      >
        ...
        <header className="text-white/70 text-center font-beba w-full bg-transparent backdrop-blur-2xl md:backdrop-blur-none pt-20 md:pt-36">
        ...
        >
          <aside
            ...
            md:grid-cols-1 gap-2 md:gap-0 w-full md:w-fit h-fit px-2 py-3 pt-4 
          ...
          <section
            ...
            lg:grid-cols-4 gap-3 content-start"
          >
